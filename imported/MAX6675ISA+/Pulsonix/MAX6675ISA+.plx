...
(library Library_1
	...
	(compDef "MAX6675ISA+" (originalName "MAX6675ISA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "T-") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "N.C.") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "SO") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__CS") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SCK") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://datasheets.maximintegrated.com/en/ds/MAX6675.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MAX6675ISA+.stp")
