...
(library Library_1
	...
	(patternDef "WE-TPC_4818/482892" (originalName "WE-TPC_4818/482892")
		(multiLayer
			(pad (padNum 1) (padStyleRef r530_200) (pt -1.75, 0) (rotation 0))
			(pad (padNum 2) (padStyleRef r530_200) (pt 1.75, 0) (rotation 0))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -3.81, -5.08) (textStyleRef "Normal") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt 2.4892 2.8004) (pt 2.4892 -2.8004) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 2.4892 -2.8004) (pt -2.4892 -2.8004) (width 0.127))
		)
	...
	(compDef "744042001" (originalName "744042001") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		...
		(attachedPattern (patternNum 1) (patternName "WE-TPC_4818/482892")
			(numPads 2)
			(padPinMap
		...
		(attr "<Hyperlink>" "")
		(attr "<STEP Filename>" "744042001.stp")
